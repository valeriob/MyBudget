namespace CommonDomain.Core
{
	...
	public class StateConventionEventRouter : IRouteEvents
	{
	    ...
	    public StateConventionEventRouter() : this(true)
	    {
	    }

	    public StateConventionEventRouter(bool throwOnApplyNotFound)
	    {
	        this.throwOnApplyNotFound = throwOnApplyNotFound;
	    }

        public StateConventionEventRouter(bool throwOnApplyNotFound, IAggregate aggregate)
