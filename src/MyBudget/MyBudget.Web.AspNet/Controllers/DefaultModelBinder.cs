...
namespace System.Web.Mvc
{
    public class DefaultModelBinder : IModelBinder
    {
        ...
        public virtual object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if (!performedFallback)
            {
                ...
                var uvp = new UnvalidatedValueProviderWrapper(bindingContext.ValueProvider);
                ValueProviderResult valueProviderResult = uvp.GetValue(bindingContext.ModelName, skipValidation: !performRequestValidation);
                    //= bindingContext.UnvalidatedValueProvider.GetValue(bindingContext.ModelName, skipValidation: !performRequestValidation);
    ...
    class UnvalidatedValueProviderWrapper : IValueProvider, IUnvalidatedValueProvider
    {
