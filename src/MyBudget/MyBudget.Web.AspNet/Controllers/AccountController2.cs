...
{
    [Authorize]
    public partial class AccountController : MyBudgetController
    {
        public AccountController()
        {
            var projection = base.ProjectionManager.GetApplicationUsers();
            UserManager = new MyBudgetUserManager(projection, base.CommandManager);
        }
        ...
        public virtual ActionResult RemoveAccountList()
        {
            var linkedAccounts = UserManager.GetLogins(User.Identity.GetUserId())
                .Select(s => new UserLoginInfo(s.LoginProvider, s.ProviderKey))
                .ToList();
